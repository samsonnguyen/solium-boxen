...
## 7. Add your encrypted password into the repository ##
    ...
    $ cp hiera/users/samsonnguyen.eyaml hiera/users/<<YOUR_GITHUB_USERNNAME>>.eyaml
    $ vi hiera/users/<<YOUR_GITHUB_USERNNAME>>.eyaml

Replace the encrypted password block with the one generated by the previous step.
